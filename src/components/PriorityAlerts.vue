      ...
      <div v-if="expanded" data-testid="alerts-content" class="mt-2 space-y-2">
        ...
        >
          <div class="text-sm">
            ...
            <span class="text-gray-600">
              — Working on
              <a :href="'https://redhat.atlassian.net/browse/' + violation.inProgressIssue.key" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:text-primary-800">{{ violation.inProgressIssue.key }}</a>
              (rank <span class="font-medium">#{{ violation.inProgressRank }}</span>) while
              <a :href="'https://redhat.atlassian.net/browse/' + violation.higherRankedIdleIssue.key" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:text-primary-800">{{ violation.higherRankedIdleIssue.key }}</a>
        ...
        >
          <div class="text-sm text-gray-600">
            <a :href="'https://redhat.atlassian.net/browse/' + issue.key" target="_blank" rel="noopener noreferrer" class="font-medium text-primary-600 hover:text-primary-800">{{ issue.key }}</a>
