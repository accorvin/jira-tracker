...
describe('PriorityAlerts', () => {
  ...
  it('shows violation cards with team name and issue keys', async () => {
    const violations = [{
      team: 'Fine Tuning',
  ...
  it('shows low priority in progress alerts', async () => {
  ...
  it('uses red styling for violations with rank gap > 50', async () => {
    const violations = [{
      team: 'Team A',
  ...
  it('uses amber styling for violations with rank gap <= 50', async () => {
    const violations = [{
      team: 'Team A',
